...
function CaseBookPDFPrintComponent() {
  const [data, setData] = useState<AllLawsuitType | null>(null);
  const caseId = useRecoilValue(caseIdState);
  const setPdfPrintLoading = useSetRecoilState(caseBookPDFPrintLoadingState);
  ...
  return (
    <>
      <PageLoadingSpinner>출력</PageLoadingSpinner>
      <div
        style={{
          position: "fixed",
          left: -99999,
...
export default CaseBookPDFPrintComponent;
